...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="container">
            <header class="header">
                <h1 id="title" class="text-center">Monthly Budget Report</h1>
                <!-- <p id="description" class="text-center">
                    Thank you for taking the time to help us improve the platform
                </p> -->
            </header>
            <div class="form-wrap">
                <form id="survey-form" action="{{route('monthly.store')}}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select name="id_permintaan" id="dropdown" name="role" class="form-control" required>
                                    <option disabled selected value>Pilih</option>
                                    @foreach($request as $list)
                                    <option value="{{$list->id}}">{{$list->nama_permintaan}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">Stock</label>
                                <input type="number" name="stock" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">FPB</label>
                                <input type="number" name="fpb" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                    </div>
