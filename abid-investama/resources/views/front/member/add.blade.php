...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="container">
            <header class="header">
                <h1 id="title" class="text-center">Member Data</h1>
                <!-- <p id="description" class="text-center">
                    Thank you for taking the time to help us improve the platform
                </p> -->
            </header>
            <div class="form-wrap">
                <form id="survey-form" action="{{route('member.store')}}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="jenis_kendaraan" id="dropdown" name="role" class="form-control" required>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label id="name-label" for="name">No Pol</label>
                                <input type="text" name="no_pol" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label id="name-label" for="name">No KWT</label>
                                <input type="text" name="no_kwt" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="datepicker">Mulai</label>
                                <input name="mulai" type="text" class="form-control datepicker" id="datepickermasuk" placeholder="Pilih Tanggal">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="datepicker">Berakhir</label>
                                <input name="akhir" type="text" class="form-control datepicker" id="datepickerkeluar" placeholder="Pilih Tanggal">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">Harga</label>
                                <input type="number" name="harga" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                    </div>
