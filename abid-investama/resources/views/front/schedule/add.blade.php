...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="container">
            <header class="header">
                <h1 id="title" class="text-center">Schedule</h1>
                <!-- <p id="description" class="text-center">
                    Thank you for taking the time to help us improve the platform
                </p> -->
            </header>
            <div class="form-wrap">
                <form id="survey-form" action="{{route('schedule.store')}}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label id="name-label" for="name">Ploting</label>
                                <input type="text" name="ploting" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                    </div>
