...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="container">
            <header class="header">
                <h1 id="title" class="text-center">Patty Cash Report</h1>
                <!-- <p id="description" class="text-center">
                    Thank you for taking the time to help us improve the platform
                </p> -->
            </header>
            <div class="form-wrap">
                <form id="survey-form" action="{{route('patty.store')}}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">Supervisor</label>
                                <input type="text" name="supervisor" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">Administrasi</label>
                                <input type="text" name="administrasi" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="keterangan_pemakaian" id="comments" class="form-control" name="comment" placeholder=""></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">Debet</label>
                                <input type="number" name="debet" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label id="name-label" for="name">Kredit</label>
                                <input type="number" name="kredit" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label id="name-label" for="name">Saldo</label>
                                <input type="number" name="saldo" id="name" placeholder="" class="form-control" required>
                            </div>
                        </div>
