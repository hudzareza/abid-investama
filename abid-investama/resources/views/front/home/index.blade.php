        ...
        <section id="hero" class="hero section">
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h1>ABID PARKING</h1>
                    <p data-aos-delay="100">Parking Management, Parking Consultant, Supplier<br></p>
                    <img src="{{ asset('storage/images/' . $filename) }}" class="img-fluid hero-img" alt="">
                </div>
            </div>
        ...
        <section id="featured-services" class="featured-services section light-background">
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <!-- <div class="col-xl-4 col-lg-6" data-aos-delay="300">
                        <div class="service-item d-flex">
                        ...
                        <ul class="nav nav-tabs" data-aos-delay="100">
                            <li class="nav-item">
                                <a class="nav-link active show" data-bs-toggle="tab" data-bs-target="#features-tab-1">
                                    ...
                                    <div>
                                        <h4 class="d-none d-lg-block">Experience</h4>
                                        <p>
                                            {{$experience}}
                                        </p>
                                    </div>
        ...
        <!-- <section id="features-details" class="features-details section">
            ...
            <div class="container">
                ...
                <div class="row gy-4 justify-content-between features-item">
                    ...
                    <div class="col-lg-5 d-flex align-items-center order-2 order-lg-1" data-aos-delay="100">
        ...
        <!-- <section id="more-features" class="more-features section">
            ...
            <div class="container">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center order-2 order-lg-1" data-aos-delay="100">
        ...
        <section id="faq" class="faq section">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-10" data-aos-delay="100">
        ...
        <section id="contact" class="contact section">
            ...
            <div class="container" data-aos-delay="100">
                ...
                <div class="row gy-4 mt-1">
                    <div class="col-lg-6" data-aos-delay="300">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.0338703531775!2d106.8435411749907!3d-6.259268893729286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f24b6dbbffff%3A0xca592411ff6c0cf9!2sPt.%20Abid%20Investama!5e0!3m2!1sid!2sid!4v1730188739434!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div><!-- End Google Maps -->
